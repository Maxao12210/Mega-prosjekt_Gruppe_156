...
inline std::map<std::string, double> coordinatesForHome = homePosition.getCoordinatesMap();

staticPositions ref1("Position nr.1", 0.005, -1.060, 0.3875, -0.930, -1.474,-0.0005);
inline std::map<std::string, double> coordinatesForRef1 = ref1.getCoordinatesMap();